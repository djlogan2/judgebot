...
public class JudgeBotController {
    ...
    public JudgeBotController(IDatabaseService databaseService) {
    ...
    public String listgames(Model uiModel, Locale locale) {
        Page<GameLog> page = databaseService.listGames(PageRequest.of(0, 25), null, false, null, true);
    ...
    public String listgames(@RequestParam(value = "page") int spage,
        ...
        Page<GameLog> page = databaseService.listGames(PageRequest.of(spage, pagesize), white, false, black, either);
    ...
    public String POSTadjudicateRules(@RequestParam("updatearray") String updates,
        ...
        List<Map<String, Object>> convertedUpdates = new ArrayList<>();
        convertedUpdates = mapper.readValue(updates, convertedUpdates.getClass());
        for (Map<String, Object> element : convertedUpdates) {
    ...
    public String winExempt(Model uiModel, Locale locale) {
        Page<WinExempt> winExemptList = this.databaseService.getWinExemptList(null, PageRequest.of(0, 25));
        Page<LoseExempt> loseExemptList = this.databaseService.getLoseExemptList(null, PageRequest.of(0, 25));
    ...
    public String POSTwinexemptlist(@RequestParam("page") int page,
                                    ...
                                    Model uiModel,
                                    Locale locale) throws Exception {
        Page<WinExempt> winExemptList = this.databaseService.getWinExemptList(search, PageRequest.of(page, pagesize));
        uiModel.addAttribute("winpage", winExemptList);
        if (search != null)
    ...
    public String POSTloseexemptlist(@RequestParam("page") int page,
                                     ...
                                     Model uiModel,
                                     Locale locale) throws Exception {
        Page<LoseExempt> loseExemptList = this.databaseService.getLoseExemptList(search, PageRequest.of(0, 25));
        uiModel.addAttribute("losepage", loseExemptList);
        if (search != null)
